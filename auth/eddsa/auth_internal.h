...
struct auth_struct {
  ...
  uint8_t ed25519_sk[crypto_sign_SECRETKEYBYTES]; /**< ed25519 secret key */
  /*@}*/

  /*@{*/
  uint8_t x25519_pk[crypto_scalarmult_curve25519_BYTES]; /**< DH x25519 public key */
  uint8_t x25519_sk[crypto_scalarmult_curve25519_BYTES]; /**< DH x25519 secret key */
  /*@}*/
...
uint8_t auth_internal_encrypt(auth_ctx_t *session, uint8_t ed25516_sk[], uint8_t *ciphertext, const uint8_t *data);
